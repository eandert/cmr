...
def calculate_mse_violations(ego_vehicle, ground_truth_objects, category="Aggressive"):
    ...
    subject_position = ego_vehicle.location
    ...
    for gt_obj in ground_truth_objects:
        ...
        dlong = gt_obj.location[0] - subject_position[0]
        dlat = gt_obj.location[1] - subject_position[1]
        ...
        min_safe_dlong = subject_speed * params["rho"] + 0.5 * params["a_decel_min"] * params["rho"]**2
        min_safe_dlat = 0.5 * params["a_decel_min"] * params["rho"]**2
